...
export const JobDetailsSkeleton = () => (
  <div className="animate-pulse max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden mt-10">
    ...
    <div className="p-8 sm:p-12 space-y-4">
      ...
      <div className="h-12 bg-gray-200 rounded w-32 mt-8"></div>
    </div>
  </div>
);
